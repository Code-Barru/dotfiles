...
hl.bind(mainMod .. " + R", hl.dsp.global("quickshell:launcher_apps"))
hl.bind(mainMod .. " + SHIFT + P", hl.dsp.global("quickshell:launcher_run"))
hl.bind(mainMod .. " + W", hl.dsp.global("quickshell:island_wallpaper"))
hl.bind(mainMod .. " + CTRL + T", hl.dsp.global("quickshell:island_theme"))
hl.bind(mainMod .. " + E", hl.dsp.exec_cmd(programs.ide))
hl.bind(mainMod .. " + B", hl.dsp.exec_cmd(programs.browser))
hl.bind(mainMod .. " + SHIFT + B", hl.dsp.exec_cmd(programs.browser .. " -p Tadao"))
hl.bind(mainMod .. " + SHIFT + L", hl.dsp.global("quickshell:lock"))
